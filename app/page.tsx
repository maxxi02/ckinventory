...
export default async function Home() {
  ...
  return (
    <BackgroundLines>
      <div className="flex items-center justify-evenly z-95 mx-auto w-full max-w-7xl ">
        {/* DESCRIPTION */}
        <div className="scale z-95 flex flex-col items-start justify-center w-full h-screen flex-1">
          <h2 className="bg-clip-text text-transparent text-start bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
            <span className="flex items-center">
              <RiBox3Fill
                className="dark:text-[whitesmoke] text-black "
                size={80}
              />
              CloudKings—
            </span>
          ...
          <p className="max-w-xl  text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-start">
